...
public class ControladorEstudiante {
    ...
    public void guardarDatos() {
        // TODO: Llamar al DAO para persistir los datos en el archivo .txt
        // Segun arquitectura: DAO se invoca aquí para escribir luego de alta, baja o modificacion
        // Ejemplo: estudianteDAO.guardar(this.estudiante);
    }

    // 6. cargar
    public void cargarDatos() {
        // TODO: Llamar al DAO para leer los datos desde el archivo .txt
        // Segun arquitectura: DAO lee los archivos aquí (llamado desde el constructor)
        // Ejemplo: this.estudiante = estudianteDAO.cargar();
        // Si el DAO retorna null (archivo no existe), se inicializa con lista vacía
        if (this.estudiante == null) {
            this.estudiante = new Estudiante("Alumno Generico", "00000", "Sistemas", 2026);
        }
    }
